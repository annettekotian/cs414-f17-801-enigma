...
-- Sat 02 Dec 2017 02:37:30 PM EST
...
CREATE TABLE IF NOT EXISTS `GymSystem`.`customer` (
  ...
  `personal_information_id` INT UNSIGNED NOT NULL,
  `user_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`, `membership_id`, `personal_information_id`, `user_id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
...
CREATE TABLE IF NOT EXISTS `GymSystem`.`customer_workout_routine` (
  ...
  `workout_routine_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`customer_id`, `workout_routine_id`),
  INDEX `fk_customer_has_workout_routine_workout_routine1_idx` (`workout_routine_id` ASC),
  INDEX `fk_customer_has_workout_routine_customer1_idx` (`customer_id` ASC),
...
-- -----------------------------------------------------
-- Table `GymSystem`.`feedback`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GymSystem`.`feedback` ;

CREATE TABLE IF NOT EXISTS `GymSystem`.`feedback` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `feedback` VARCHAR(255) NOT NULL,
  `customer_id` INT UNSIGNED NULL,
  `workout_routine_id` INT UNSIGNED NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_feedback_customer1_idx` (`customer_id` ASC),
  INDEX `fk_feedback_workout_routine1_idx` (`workout_routine_id` ASC),
  CONSTRAINT `fk_feedback_customer1`
    FOREIGN KEY (`customer_id`)
    REFERENCES `GymSystem`.`customer` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
  CONSTRAINT `fk_feedback_workout_routine1`
    FOREIGN KEY (`workout_routine_id`)
    REFERENCES `GymSystem`.`workout_routine` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
