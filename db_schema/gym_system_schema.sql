...
-- Fri 20 Oct 2017 10:16:15 AM EDT
...
CREATE TABLE IF NOT EXISTS `GymSystem`.`duration` (
  ...
  INDEX `fk_duration_exercise1_idx` (`exercise_id` ASC),
  CONSTRAINT `fk_duration_exercise1`
...
START TRANSACTION;
USE `GymSystem`;
INSERT INTO `GymSystem`.`health_insurance` (`id`, `description`) VALUES (DEFAULT, 'Cigna');
INSERT INTO `GymSystem`.`health_insurance` (`id`, `description`) VALUES (DEFAULT, 'Blue Cross Blue Shield');
...
INSERT INTO `GymSystem`.`state` (`id`, `state`, `state_abbrev`) VALUES (21, 'Massachusetts', 'MS');
...
INSERT INTO `GymSystem`.`state` (`id`, `state`, `state_abbrev`) VALUES (49, 'Wisonsin', 'WI');
